...
int main(void)
{
	uart2_tx_init(); // CORRECTED: Typo in function name was "uar2_tx_init"
	while(1)
	{
		// CORRECTED: To send a string, you must write one character at a time.
		// The original 'RAM\n' is a multi-character literal which does not work as intended.
		uart2_write('R');
	}
}
...
void uart2_tx_init(void){
	...
	// CORRECTED: Original code had redundant lines and did not correctly set AF7.
	// This robustly clears the 4 bits for PA2 and sets them to 0111 (AF7).
